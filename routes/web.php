...
Route::get('/parking/search-ajax', [ParkingController::class, 'searchAjax'])->name('parking.search.ajax');
...
Route::get('/lodging/search-ajax', [LodgingController::class, 'searchAjax'])->name('lodging.search.ajax');
Route::delete('/lodging/{id}', [LodgingController::class, 'destroy'])->name('lodging.destroy');
Route::get('/lodging/report', [LodgingController::class, 'report'])->name('lodging.report');
...
Route::get('/animals/chart', [AnimalsController::class, 'chart'])->name('animals.chart');
